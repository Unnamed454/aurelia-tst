    ...
    var App = (function () {
        ...
        App.prototype.configureRouter = function (config, router) {
            ...
            config.map([
                ...
                { route: 'contacts/add', moduleId: 'contact-add', name: 'contact-add' }
            ]);
            this.router = router;
        };
        return App;
...
define('contact-add',["require", "exports", "aurelia-event-aggregator", "./web-api", "aurelia-framework", "./messages"], function (require, exports, aurelia_event_aggregator_1, web_api_1, aurelia_framework_1, messages_1) {
    "use strict";
    var ContactAdd = (function () {
        function ContactAdd(api, ea) {
            this.api = api;
            this.ea = ea;
        }
        ContactAdd.prototype.activate = function () {
            this.ea.publish(new messages_1.ContactAdded());
        };
        return ContactAdd;
    }());
    ContactAdd = __decorate([
...
define('messages',["require", "exports"], function (require, exports) {
    ...
    exports.ContactAdded = ContactAdded;
});
...
define('contact-list',["require", "exports", "aurelia-event-aggregator", "./web-api", "./messages", "aurelia-framework"], function (require, exports, aurelia_event_aggregator_1, web_api_1, messages_1, aurelia_framework_1) {
    ...
    var ContactList = (function () {
        function ContactList(api, ea) {
            ...
            ea.subscribe(messages_1.ContactAdded, function (msg) { return _this.newContact(); });
